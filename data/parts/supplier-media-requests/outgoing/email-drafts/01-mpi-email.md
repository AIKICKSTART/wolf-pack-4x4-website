# Email Draft 1: MPI Automotive

To: sales@mpiautomotive.com

Phone: 1300 310 330

Subject: Product image export request for Oak Flats Muffler Men catalogue - MPI Automotive

Attachment: `data\parts\supplier-media-requests\outgoing\2026-05-18-mpi-media-request.zip`

Contact source: https://www.mpiautomotive.com/
...
- P1 launch-blocking rows: 503
- P2 image request rows: 485
- P3 exception-review rows: 0
- Total rows in this supplier request: 988
...
- mpi-p1.csv for P1 rows
- mpi-all.csv for all missing-media rows
- mpi-request.md for the full request notes
