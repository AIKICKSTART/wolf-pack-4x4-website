...
export const LOGO = "/media/wolfpack/wolfpack-logo-transparent.png"
...
export const FEATURED_BUILD_COLLAGE = [
  {
    cls: "hero",
    src: "/media/wolfpack/vehicles/ford-ranger-raptor-wolfpack.png",
  ...
  {
    cls: "side",
    src: "/media/wolfpack/vehicles/toyota-hilux-gr-sport-wolfpack.png",
  ...
  {
    cls: "rear",
    src: "/media/wolfpack/vehicles/nissan-patrol-warrior-wolfpack.png",
  ...
  {
    cls: "detail",
    src: "/media/wolfpack/merch/founding-wolfpack-shirt.png",
...
export const GALLERY_TILES = [
  ...
  {
    cls: "t4",
    src: "/media/wolfpack/vehicles/isuzu-dmax-blade-wolfpack.png",
  ...
  {
    cls: "t5",
    src: "/media/wolfpack/vehicles/mitsubishi-triton-gsr-wolfpack.png",
  ...
  {
    cls: "t6",
    src: "/media/wolfpack/vehicles/toyota-landcruiser-79-wolfpack.png",
